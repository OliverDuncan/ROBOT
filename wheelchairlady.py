...
class WheelchairLady:
    ...
    def run(self):
        ...
        self.robot.backwardRampUp(30,3)
        ...
        self.robot.backwardRampUp(20,.4)
        #self.robot.resetGyro()
        self.robot.turnright(10,121)
        self.robot.forwardRampUp(20,0.5)
